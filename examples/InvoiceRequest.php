...
$invoice->setResendFlag(false);

$invoiceRequest = new InvoiceRequest($invoice);
$res = $client->sendRequest($invoiceRequest);

echo '<b>Request:</b><pre>', htmlentities($invoiceRequest->toXML()), '</pre>';
